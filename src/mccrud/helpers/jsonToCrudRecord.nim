...
proc jsonToCrudSave*(params: SaveParamType, jNode: JsonNode): SaveParamType =
    # TODO: compose CRUD meta-data based on JSON data request and defined model
    var computedValue: SaveParamType
    # map json values into params
    for fieldName, fieldDesc in params.fields.pairs():
        # errorChecking
        var errorMessage = ""
        var 
...
proc jsonToCrudRead*(model: ModelType, jNode: JsonNode): SaveParamType =
    # TODO: compose CRUD meta-data based on JSON data request and defined model
...
proc jsonToCrudDelete*(model: ModelType, jNode: JsonNode): SaveParamType =
    # TODO: compose CRUD meta-data based on JSON data request and defined model
    for fieldName, fieldDesc in model.recordDesc.pairs():
        # errorChecking
        var errorMessage = ""
